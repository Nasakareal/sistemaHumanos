        ...
        <div class="col-md-12">
            <div class="card card-outline card-primary">
                <div class="card-header">
                    <h3 class="card-title">Llene los Datos del Empleado</h3>
                </div>
                <div class="card-body">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="puesto" id="puesto"
                                           ...
                                           value="{{ old('puesto') }}" placeholder="Puesto laboral" required>
                                    @error('puesto')
                                        <span class="invalid-feedback"><strong>{{ $message }}</strong></span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="area_adscripcion" id="area_adscripcion"
                                           ...
                                           value="{{ old('area_adscripcion') }}" placeholder="Área adscrita">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="lugar_nacimiento" id="lugar_nacimiento"
                                           ...
                                           value="{{ old('lugar_nacimiento') }}" placeholder="Ciudad, Estado">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="nss" id="nss"
                                           ...
                                           value="{{ old('nss') }}" placeholder="Número de Seguro Social" required>
                                    @error('nss')
                                        <span class="invalid-feedback"><strong>{{ $message }}</strong></span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="email" name="correo_electronico" id="correo_electronico"
                                           ...
                                           value="{{ old('correo_electronico') }}" placeholder="ejemplo@dominio.com" required>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="rfc" id="rfc"
                                           ...
                                           value="{{ old('rfc') }}" placeholder="RFC del empleado" required>
                                    @error('rfc')
                                        <span class="invalid-feedback"><strong>{{ $message }}</strong></span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="curp" id="curp"
                                           ...
                                           value="{{ old('curp') }}" placeholder="CURP del empleado" required>
                                    @error('curp')
                                        <span class="invalid-feedback"><strong>{{ $message }}</strong></span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="domicilio" id="domicilio"
                                           ...
                                           value="{{ old('domicilio') }}" placeholder="Ej. Calle X #111, Col. Centro">
                                    @error('domicilio')
                                        <span class="invalid-feedback"><strong>{{ $message }}</strong></span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="colonia" id="colonia"
                                           ...
                                           value="{{ old('colonia') }}" placeholder="Colonia o barrio">
                                    @error('colonia')
                                        <span class="invalid-feedback"><strong>{{ $message }}</strong></span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="no_ext" id="no_ext"
                                           ...
                                           value="{{ old('no_ext') }}" placeholder="Núm. Exterior">
                                    @error('no_ext')
                                        <span class="invalid-feedback"><strong>{{ $message }}</strong></span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="no_int" id="no_int"
                                           ...
                                           value="{{ old('no_int') }}" placeholder="Núm. Interior">
                                    @error('no_int')
                                        <span class="invalid-feedback"><strong>{{ $message }}</strong></span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="poblacion" id="poblacion"
                                           ...
                                           value="{{ old('poblacion') }}" placeholder="Ciudad o municipio">
                                    @error('poblacion')
                                        <span class="invalid-feedback"><strong>{{ $message }}</strong></span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="telefono" id="telefono"
                                           ...
                                           value="{{ old('telefono') }}" placeholder="Ej. (000) 000-0000">
                                    @error('telefono')
                                        <span class="invalid-feedback"><strong>{{ $message }}</strong></span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="celular" id="celular"
                                           ...
                                           value="{{ old('celular') }}" placeholder="Ej. (000) 000-0000">
                                    @error('celular')
                                        <span class="invalid-feedback"><strong>{{ $message }}</strong></span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="licenciatura" id="licenciatura"
                                           ...
                                           value="{{ old('licenciatura') }}" placeholder="Ej. Ingeniería en Sistemas">
                                    @error('licenciatura')
                                        <span class="invalid-feedback"><strong>{{ $message }}</strong></span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="edad_hijos" id="edad_hijos"
                                           ...
                                           value="{{ old('edad_hijos') }}" placeholder="Ej. 10">
                                    @error('edad_hijos')
                                        <span class="invalid-feedback"><strong>{{ $message }}</strong></span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="tipo_sanguineo" id="tipo_sanguineo"
                                           ...
                                           value="{{ old('tipo_sanguineo') }}" placeholder="Ej. O+, A-">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="alergias" id="alergias"
                                           ...
                                           value="{{ old('alergias') }}" placeholder="Ej. Penicilina, polen...">
                                    @error('alergias')
                                        <span class="invalid-feedback"><strong>{{ $message }}</strong></span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea name="restricciones_salud" id="restricciones_salud"
                                              ...
                                              rows="2"
                                              placeholder="Describa si el empleado tiene alguna restricción">{{ old('restricciones_salud') }}</textarea>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="contacto_emergencia_nombre" id="contacto_emergencia_nombre"
                                           ...
                                           value="{{ old('contacto_emergencia_nombre') }}" placeholder="Nombre de contacto">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="contacto_emergencia_telefono" id="contacto_emergencia_telefono"
                                           ...
                                           value="{{ old('contacto_emergencia_telefono') }}" placeholder="Ej. (000) 000-0000">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="contacto_emergencia_domicilio" id="contacto_emergencia_domicilio"
                                           ...
                                           value="{{ old('contacto_emergencia_domicilio') }}" placeholder="Domicilio del contacto">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <select name="desempena_otro_trabajo" id="desempena_otro_trabajo"
                                        ...
                                        <option value="0" {{ old('desempena_otro_trabajo', '0') == '0' ? 'selected' : '' }}>No</option>
                                        <option value="1" {{ old('desempena_otro_trabajo') == '1' ? 'selected' : '' }}>Sí</option>
                                    </select>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="otra_dependencia" id="otra_dependencia"
                                           ...
                                           value="{{ old('otra_dependencia') }}" placeholder="Nombre de la otra dependencia">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="otro_trabajo_horario" id="otro_trabajo_horario"
                                           ...
                                           value="{{ old('otro_trabajo_horario') }}" placeholder="Ej. L-V 7:00 a 15:00">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="otro_trabajo_puesto" id="otro_trabajo_puesto"
                                           ...
                                           value="{{ old('otro_trabajo_puesto') }}" placeholder="Puesto que desempeña">
