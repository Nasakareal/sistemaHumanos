        ...
        <div class="content">
            ...
            <div class="buttons-container">
                ...
                <div class="system-card">
                    ...
                    <a href="{{ request()->getHost() === 'localhost' ? '/sistemaInventarios/login' : '/sistemaInventarios/login' }}">
                ...
                <div class="system-card">
                    ...
                    <a href="{{ request()->getHost() === 'localhost' ? '/sistemaContable/login' : '/sistemaContable/login' }}">
                ...
                <div class="system-card">
                    ...
                    <a href="{{ request()->getHost() === 'localhost' ? '/sistemaHumanos/login' : '/sistemaHumanos/login' }}">
